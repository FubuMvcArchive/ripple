...
{
    [TestFixture]
    public class LessThanOrEqualRuleTester
    {
        [Test]
        public void matches_when_target_version_is_less_than_configured()
        {
            ...
            new LessThanOrEqualRule(configured).Matches(target).ShouldBeTrue();
        }
        ...
        public void no_match_when_target_version_is_greater_than_configured()
        {
            ...
            new LessThanOrEqualRule(configured).Matches(target).ShouldBeFalse();
        }
    }
}